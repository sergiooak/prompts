...
Cada prompt é uma linha: um emoji (âncora visual, não chave de busca) seguido de uma instrução pronta pra rodar. Abra [`topics/coding/general.md`](./topics/coding/general.md), pegue o que precisar, cole na ferramenta que estiver usando.
